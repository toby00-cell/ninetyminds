...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "NinetyMinds" },
      { property: "og:title", content: "NinetyMinds — Grassroots football, healthy minds." },
      { property: "og:description", content: "Nigeria's scouting and mental wellness platform for grassroots footballers." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@NinetyMinds" },
    ],
    links: [
      {
        rel: "preconnect",
