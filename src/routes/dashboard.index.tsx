      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 py-12 lg:py-20">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card border border-border rounded-2xl p-6 sm:p-8">
              <div className="flex items-center justify-between mb-3">
                ...
                {!editingBio && (
                  <button onClick={() => setEditingBio(true)} className="text-xs font-medium text-pitch hover:underline">
                    Edit
                  </button>
                )}
              </div>
        ...
        {profile?.type === "scout" && (
          <div className="bg-card border border-border rounded-2xl p-6 sm:p-8">
            ...
            <Link to="/featured-players" className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-ink text-cream text-sm font-medium hover:bg-pitch transition-colors">
              Browse players →
            </Link>
          </div>
        )}
